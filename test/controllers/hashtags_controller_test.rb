...
class HashtagsControllerTest < ActionController::TestCase
  ...
  test "should create hashtag" do
    assert_difference('Hashtag.count') do
      post :create, hashtag: { id_actor: @hashtag.id_actor, id_hashtag: @hashtag.id_hashtag, nombre_hashtag: @hashtag.nombre_hashtag }
    end
  ...
  test "should update hashtag" do
    patch :update, id: @hashtag, hashtag: { id_actor: @hashtag.id_actor, id_hashtag: @hashtag.id_hashtag, nombre_hashtag: @hashtag.nombre_hashtag }
    assert_redirected_to hashtag_path(assigns(:hashtag))
  end
